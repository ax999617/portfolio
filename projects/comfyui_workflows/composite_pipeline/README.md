...
- Original workflow file: `<local-source>/comfyui/workflows/综合工作流.json`
...
Example output copied from `<local-source>/comfyui/output/ComfyUI_02152_.png` into `example_outputs/ComfyUI_02152_.png`. For generic filename prefixes, treat this as a local output candidate rather than a guaranteed single-workflow artifact.
