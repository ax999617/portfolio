...
3. copies the selected frozen result assets from `reference_results/original/` or the local source root into `outputs/result_assets/original/`;
4. renders the two selected scientific PDFs into PNG previews;
5. copies the selected SPSS image into the preview set;
